package com.brewing.dudeling.gallery.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.brewing.dudeling.gallery.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.brewing.dudeling.gallery.repository.UserRepository.USERS_BY_EMAIL_CACHE);
