  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="studentArtGalleryApp.photo.home.createOrEditLabel">
            <Translate contentKey="studentArtGalleryApp.photo.home.createOrEditLabel">Create or edit a Photo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
