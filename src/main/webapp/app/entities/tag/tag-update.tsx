  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="studentArtGalleryApp.tag.home.createOrEditLabel">
            <Translate contentKey="studentArtGalleryApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
