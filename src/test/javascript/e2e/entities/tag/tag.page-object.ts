...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('studentArtGalleryApp.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/studentArtGalleryApp.tag.delete.question/);
