...
export class PhotoDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('studentArtGalleryApp.photo.delete.question'));
...
export default class PhotoComponentsPage {
  ...
  async deletePhoto() {
    ...
    expect(await photoDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/studentArtGalleryApp.photo.delete.question/);
