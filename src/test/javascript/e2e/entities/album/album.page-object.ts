...
export class AlbumDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('studentArtGalleryApp.album.delete.question'));
...
export default class AlbumComponentsPage {
  ...
  async deleteAlbum() {
    ...
    expect(await albumDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/studentArtGalleryApp.album.delete.question/);
